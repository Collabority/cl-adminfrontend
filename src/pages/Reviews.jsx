        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-xs sm:text-sm">
            ...
            <tbody>
              ...
              {sorted.length === 0 && (
                <tr>
                  <td colSpan="4" className="text-center text-gray-400 py-6 text-base">No reviews found.</td>
                </tr>
              )}
            </tbody>
          </table>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <div className="mb-2">
              ...
              <input className="w-full border rounded px-2 py-1 text-base" value={editForm.name} onChange={e => setEditForm(f => ({ ...f, name: e.target.value }))} />
            </div>
            <div className="mb-2">
              <label className="block text-base font-semibold">Title</label>
              <input className="w-full border rounded px-2 py-1 text-base" value={editForm.title} onChange={e => setEditForm(f => ({ ...f, title: e.target.value }))} />
            </div>
            <div className="mb-2">
              <label className="block text-base font-semibold">Review</label>
              <textarea className="w-full border rounded px-2 py-1 text-base" value={editForm.review} onChange={e => setEditForm(f => ({ ...f, review: e.target.value }))} />
            </div>
            <div className="mb-2">
              <label className="block text-base font-semibold">Rating</label>
              <input type="number" min="1" max="5" className="w-16 border rounded px-2 py-1 text-base" value={editForm.rating} onChange={e => setEditForm(f => ({ ...f, rating: Number(e.target.value) }))} />
            </div>
            <div className="mb-2">
            ...
            <div className="flex gap-2 mt-4">
              <button className="bg-blue-600 text-white px-4 py-2 rounded text-base" onClick={handleEditSave}>Save</button>
              <button className="bg-gray-300 px-4 py-2 rounded text-base" onClick={() => setEditingReview(null)}>Cancel</button>
            </div>
          </div>
        </div>
      )}
